...
\address{University of Wyoming \\ 1000 E. University Ave., Laramie, WY 82071} % Your address
\address{nathan.wisnoski@uwyo.edu \\ \href{https://www.nathanwisnoski.com}{nathanwisnoski.com}} % Your phone number and email
...
\item Albeke Lab: community assembly, biogeography, individual-based modeling, ecoinformatics 
\item Shoemaker Lab: coexistence theory, metacommunity ecology, dispersal, and dormancy
\end{rSubsection}

\begin{rSubsection}{Graduate Researcher}{August 2014 -- May 2020}{Indiana University}{Bloomington, IN}
\item Lennon Lab: metacommunity ecology, freshwater microbial ecology, multivariate statistics, simulation modeling, and synthesis research
\end{rSubsection}

\begin{rSubsection}{Graduate Teaching Assistant}{August 2014 -- May 2020}{Lennon Lab, Indiana University}{Bloomington, IN}
\item Courses: Quantitative Biodiversity, Intro Biology, Biology Lab
\end{rSubsection}
...
\begin{rSubsection}{Undergraduate Researcher}{Summer 2012 -- Spring 2014}{University of Texas}{Austin, TX}
\item Leibold Lab: metacommunity ecology, algal/protist microcosms
\end{rSubsection}
...
\begin{Prep}{Mobilian, C., {\bf N.I. Wisnoski}, J.T. Lennon, M. Alber, S. Widney, C.B. Craft. In revision}{Differential effects of press versus pulse seawater intrusion on microbial communities of a tiday freshwater marsh.}
\end{Prep}
...
{\bf Journals}: The American Naturalist, Aquatic Ecology, BioScience, Ecology, Ecology Letters, Environmental Microbiology, the ISME Journal, and Journal of Biogeography.

{\bf Books}: Kirchman (2018) Processes in Microbial Ecology (2nd Ed.)
\end{rSection}
\bigskip
...
{\bf STEM Mentorship:} \hfill Jan 2015 -- 2020
\begin{itemize}
...
\begin{itemize}
  \item Moderator, {\em Advancing Ecological Theory through Synthesis of Long-Term Ecological Research}, Organized Oral Session, ESA 2017, Portland.
  \item EcoLunch Co-Organizer \hfill August 2015 -- May 2016
  \item Metacommunity Reading Group Organizer \hfill Summer 2015
\end{itemize}


{\bf Departmental Service:}
\begin{itemize}
  \item Host, Graduate Recruiting Weekend, Biology Dept. Indiana University \hfill 2014 -- 2020
