...
\begin{Prep}{{\bf Wisnoski, N.I.}, R. Andrade, M.C.N. Castorani, C.P. Catano, A. Compagnoni, T. Lamy, N.K. Lany, L. Marazzi, S. Record, A.C. Smith, C.M. Swan, J.D. Tonkin, N.M. Voelker, P.L. Zarnetske, and E.R. Sokol}{Diversity-stability relationships become decoupled across spatial scales: a synthesis of organism and ecosystem types. Submitted, preprint available on bioRxiv.}
\end{Prep}
...
\begin{Publication}{{\bf Wisnoski, N.I.} and J.T. Lennon}{Accepted}{}{Scaling up and down: movement ecology for microorganisms}
\end{Publication}
